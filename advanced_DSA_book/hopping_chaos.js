...
// function hoppingChaos(n, memo = new Map([[1, 1], [2, 2]])) {
//   return memo.get(n) ?? memo.set(n, hoppingChaos(n - 1, memo) + hoppingChaos(n - 2, memo)).get(n);
// }
...
// All test cases should log truewaysToGetToStacki.
